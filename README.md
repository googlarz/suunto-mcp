...
![OAuth application settings form on the apizone profile page](assets/screenshots/apizone-oauth-settings.png)
...
![Subscriptions section on the apizone profile page showing the Primary Key reveal button](assets/screenshots/apizone-subscription-key.png)
...
![Suunto OAuth authorization screen showing the Authorize button](assets/screenshots/suunto-authorize.png)
